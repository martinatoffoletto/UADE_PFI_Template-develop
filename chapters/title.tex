\begin{titlepage}
    ...
    {\textbf{\fontsize{13}{16}\selectfont Plataforma digital de logística urbana colaborativa\\ para PyMEs y particulares del AMBA\\ que reduce costos y emisiones de CO\textsubscript{2}} \par}
    \vspace{0.5cm}
