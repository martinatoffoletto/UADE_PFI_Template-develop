...
\begin{table}[H]
    ...
    \begin{tabular}{p{3.1cm}p{1.9cm}p{8.6cm}}
        ...
        Amenaza de nuevos entrantes & Media & Clonar la funcionalidad es tecnológicamente accesible, pero alcanzar liquidez en un mercado de dos lados exige masa crítica simultánea en la oferta y en la demanda \parencite{AkamatsuOyama2023}; el efecto de red protege a quien la alcanza primero. \\
...
\begin{table}[H]
    ...
    \begin{tabular}{p{6.8cm}p{6.8cm}}
        ...
        \begin{itemize}[leftmargin=1.2em,topsep=1pt,itemsep=1pt]
            ...
            \item Cálculo de CO\textsubscript{2} por envío y propuesta contrastada con la investigación de usuarios propia (n = 145): 69,8~\% de predisposición al modelo colaborativo y 84,5~\% de interés en transportar.
        \end{itemize}
        &
        \begin{itemize}[leftmargin=1.2em,topsep=1pt,itemsep=1pt]
            ...
            \item Mecanismo de cobertura ante daños aún no definido: el encuadre como intermediaria delimita la responsabilidad de la plataforma, pero traslada el riesgo al transportista.
            \item Tarifa determinística, sin elasticidad dinámica ante desequilibrios entre oferta y demanda.
        ...
        \begin{itemize}[leftmargin=1.2em,topsep=1pt,itemsep=1pt]
            ...
            \item Adopción de hábitos de consumo digital que normalizan la entrega a domicilio.
        \end{itemize}
        &
        \begin{itemize}[leftmargin=1.2em,topsep=1pt,itemsep=1pt]
            ...
            \item Sensibilidad al precio, que comprime el margen disponible para la plataforma.
