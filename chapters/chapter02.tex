...
El relevamiento de competidores y la matriz comparativa del estado del arte se complementan con dos herramientas de análisis estratégico que permiten evaluar el atractivo del mercado y la posición relativa de DePaso: el modelo de las cinco fuerzas de Porter y la matriz FODA.

% ─────────────────────────────────────────────────────────────────────────────
\subsection{Cinco fuerzas de Porter}

El modelo de Porter caracteriza la intensidad competitiva del sector de la logística urbana de última milla en el AMBA.
...
\begin{table}[ht]
    ...
    \small
    \begin{tabular}{p{3.4cm}p{2.2cm}p{8cm}}
        \toprule
        \textbf{Fuerza} & \textbf{Intensidad} & \textbf{Análisis} \\
        \midrule
        Rivalidad entre competidores & Alta & Operan múltiples plataformas consolidadas y bien financiadas (Rappi, PedidosYa, Uber, DiDi, Moova, Treggo, OCA, Andreani), aunque ninguna cubre el nicho híbrido colaborativo con clasificación por IA y cálculo de CO\textsubscript{2}. \\
        Amenaza de nuevos entrantes & Media-alta & Las barreras tecnológicas son moderadas, pero el modelo de dos lados exige masa crítica simultánea de remitentes y transportistas; el efecto de red protege a quien la alcanza primero. El riesgo mayor es que un incumbente replique la modalidad colaborativa. \\
        Poder de los clientes (remitentes) & Alto & El costo de cambio es bajo y la sensibilidad al precio es marcada (el 75\% elige por costo, según la encuesta); existen numerosas alternativas. \\
        Poder de los proveedores (transportistas) & Medio & Los transportistas ocasionales son abundantes, pero su participación depende de la conveniencia y no de la exclusividad: su poder reside en la facilidad de no participar si el desvío o la compensación no los favorecen. \\
        Amenaza de sustitutos & Media-alta & El envío propio (vehículo particular, retiro en el local), el correo tradicional y la mensajería informal (changas, grupos de redes sociales) compiten como alternativas de bajo costo. \\
        \bottomrule
    \end{tabular}
\end{table}

Del análisis se desprende que las fuerzas dominantes son la rivalidad y el poder de los clientes. DePaso las mitiga posicionándose en un segmento no atendido (envíos de PyMEs y particulares bajo modelo colaborativo) y construyendo un efecto de red de dos lados que eleva la barrera de imitación.

% ─────────────────────────────────────────────────────────────────────────────
\subsection{Matriz FODA}

La matriz FODA sintetiza los factores internos (fortalezas y debilidades) y externos (oportunidades y amenazas) que condicionan la viabilidad del proyecto.
...
\begin{table}[ht]
    ...
    \begin{tabular}{p{6.8cm}p{6.8cm}}
        ...
        \begin{itemize}[leftmargin=1.2em,topsep=1pt,itemsep=1pt]
            \item Modelo híbrido (dedicado + colaborativo) único en el mercado local.
            \item Clasificación de carga por IA propia y cálculo de CO\textsubscript{2} por envío.
            \item Asignación explicable y auditable.
            \item Bajo costo operativo (infraestructura de nivel gratuito).
            \item Propuesta respaldada por evidencia de usuarios (encuesta, n = 145).
        \end{itemize}
        &
        \begin{itemize}[leftmargin=1.2em,topsep=1pt,itemsep=1pt]
            \item Arranque en frío: sin datos históricos ni masa crítica inicial.
            \item Dependencia de la adopción simultánea de ambos lados del mercado.
            \item Exactitud aún moderada del clasificador de carga.
            \item Cobertura ante daños todavía sin resolver.
            \item Equipo y presupuesto acotados.
        \end{itemize} \\
        \midrule
        ...
        \begin{itemize}[leftmargin=1.2em,topsep=1pt,itemsep=1pt]
            ...
            \item Creciente conciencia ambiental y crecimiento del comercio electrónico.
            \item Amplia base de personas que buscan ingresos complementarios.
        \end{itemize}
        &
        \begin{itemize}[leftmargin=1.2em,topsep=1pt,itemsep=1pt]
            \item Que un competidor consolidado replique la modalidad colaborativa.
            \item Incertidumbre regulatoria sobre el trabajo en plataformas.
            \item Sensibilidad al precio que limita el margen de comisión.
            \item Barreras de confianza en transacciones entre particulares.
        \end{itemize} \\
        \bottomrule
    \end{tabular}
\end{table}

La lectura cruzada de la matriz orienta la estrategia: las fortalezas diferenciales (modelo híbrido, IA propia y transparencia ambiental) se apalancan sobre la oportunidad de un segmento desatendido, mientras que la principal debilidad —el arranque en frío— se aborda con el diseño determinístico del \emph{matching}, que no requiere datos históricos, y la amenaza de imitación se contrarresta con la construcción temprana del efecto de red.
