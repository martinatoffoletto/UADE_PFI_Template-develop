...
\begin{itemize}[leftmargin=2em]
    ...
    \item \textbf{PyMEs y comercios}: al no disponer de flota propia, contratar un flete dedicado les exige pagar un vehículo completo para realizar envíos pequeños o medianos, limitando los márgenes en cada operación. A esto se suma que la incertidumbre respecto del precio y la disponibilidad de un flete les dificulta comprometerse con sus propios clientes, ya sea para trasladar una tarifa de envío previsible o para garantizar un envío sin cargo. Por otra parte, contar con un sistema de envíos de rango más amplio les permitiría llegar a clientes que no pueden retirar en el local por cuestiones de tiempo o movilidad.
...
\begin{itemize}[leftmargin=2em]
  ...
  \item\textbf{Objetivos al usar el producto} \hfill \\
    Busca sacarle algún provecho económico a un viaje que de todos modos ya realiza, sin sumar tareas que le compliquen la jornada ni la obliguen a comprometer horarios fijos.
  \item\textbf{Frustraciones y obstáculos actuales} \hfill \\
  ...
  \item\textbf{Comportamientos y hábitos relevantes} \hfill \\
	Usa el auto y por lo general viaja con el baúl vacío. Es cuidadosa con la organización de su tiempo y, como valor secundario, le agrada la idea de que su recorrido diario sirva para algo más y no se sume otro vehículo a la calle. El precio mínimo que esperaría cobrar ronda los \$3.000--\$4.000 por llevar un paquete chico.
  \item\textbf{Cita representativa} \hfill \\
