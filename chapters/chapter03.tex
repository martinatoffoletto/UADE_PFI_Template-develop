...
\begin{minipage}[c]{0.24\textwidth}
    \centering
    % Al incorporar la imagen del arquetipo, reemplazar la linea siguiente por:
    % \includegraphics[width=0.9\linewidth]{figures/persona-juan}
    \marcador[0.9\linewidth]{3cm}{Imagen del\\ arquetipo}
\end{minipage}\hfill
...
\begin{minipage}[c]{0.24\textwidth}
    \centering
    % Al incorporar la imagen del arquetipo, reemplazar la linea siguiente por:
    % \includegraphics[width=0.9\linewidth]{figures/persona-maria}
    \marcador[0.9\linewidth]{3cm}{Imagen del\\ arquetipo}
\end{minipage}\hfill
\begin{minipage}[c]{0.72\textwidth}
    {\textbf{María Álvarez}} \\
...
\begin{minipage}[c]{0.24\textwidth}
    \centering
    % Al incorporar la imagen del arquetipo, reemplazar la linea siguiente por:
    % \includegraphics[width=0.9\linewidth]{figures/persona-carlos}
    \marcador[0.9\linewidth]{3cm}{Imagen del\\ arquetipo}
\end{minipage}\hfill
\begin{minipage}[c]{0.72\textwidth}
    {\textbf{Carlos Gómez}} \\
