...
\begin{figure}[H]
    ...
    \end{tikzpicture}
    \caption[Indicadores clave de la encuesta, por lado del mercado]{Indicadores clave de la encuesta, por lado del mercado. La barra sin relleno mide una barrera de adopción y no una adhesión: es la proporción de transportistas potenciales que declara la responsabilidad ante daños como su principal preocupación}
    \label{fig:encuesta}
\end{figure}
