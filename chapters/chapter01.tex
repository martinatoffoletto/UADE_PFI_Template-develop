...
El entrenamiento del clasificador de carga requerirá un conjunto de imágenes etiquetadas según las categorías volumétricas definidas. Dicho conjunto se conformará a partir de \emph{datasets} públicos de gran escala con anotaciones verificadas, en particular Google Open Images, de uso extendido en la comunidad de visión computacional, lo que respalda la confiabilidad de su origen. Estas imágenes se complementarán, en la medida en que resulte viable, con fotografías propias de objetos representativos del contexto local, destinadas a reducir el sesgo de dominio. Se estima un volumen total del orden de 1.500 imágenes, cifra preliminar que podrá ajustarse según la disponibilidad de ejemplares adecuados por categoría y los resultados de las primeras evaluaciones del modelo.

Como tratamiento preliminar de los datos se prevé la curación manual del conjunto (descarte de imágenes ambiguas, duplicadas o de baja calidad), el etiquetado en las categorías volumétricas definidas, el balanceo de clases, la normalización de las imágenes y la aplicación de técnicas de aumento de datos (\emph{data augmentation}). La evaluación del modelo contemplará, además del \emph{accuracy} y la matriz de confusión, el análisis de sesgos asociados a condiciones de iluminación, ángulo y fondo de las fotografías.
