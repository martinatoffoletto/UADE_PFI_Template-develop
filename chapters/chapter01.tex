...
La magnitud de estas problemáticas se refleja en datos del sector. La entrega de última milla concentra una fracción desproporcionada del costo logístico total y constituye el tramo más ineficiente de la cadena de distribución \parencite{YangEtAl2022}. Esta ineficiencia tiende a agravarse: de mantenerse las tendencias actuales, se proyecta que para 2030 la demanda de entregas urbanas crezca un 78~\%, con un aumento del 36~\% en la cantidad de vehículos de reparto, del 32~\% en las emisiones de CO\textsubscript{2} y del 21~\% en la congestión de las principales ciudades \parencite{WEF2020}. En el plano local, un relevamiento de la Organización Internacional del Trabajo sobre trabajadores de plataformas de reparto en la Argentina encontró que el 95~\% de quienes habían ingresado recientemente lo hizo ante la dificultad de conseguir otro empleo \parencite{OIT2020}.
...
\begin{itemize}[leftmargin=2em]
    ...
    \item Desarrollar un mecanismo de estimación del impacto ambiental que calcule el ahorro de CO\textsubscript{2} de cada envío colaborativo respecto de un escenario equivalente de transporte dedicado, a partir de factores de emisión estandarizados por tipo de vehículo.

    \item Diseñar e implementar una plataforma digital escalable que integre los distintos componentes funcionales necesarios para la gestión de envíos urbanos, con una cobertura geográfica objetivo del AMBA.
\end{itemize}
