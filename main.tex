...
\usepackage[backend=biber, style=iso-numeric, sorting=none, language=spanish]{biblatex}
...
\newpagestyle{ruled}{
	\sethead{\includegraphics[width=3.7cm]{./images/UADE_LARGE}}
			{\parbox[b]{0.43\textwidth}{\raggedright\MakeUppercase{DePaso --- Plataforma de logística urbana colaborativa}}}
			{
				\raisebox{1.5ex}{%
