...
% Captura de pantalla de la app, con un borde fino que la delimita del fondo
% de la p\'agina. Alineada al tope para que conviva en la misma fila con los
% \marcador que a\'un esperan material.
%   Uso: \mockup{ancho}{ruta/sin/extension}
% El ancho pedido incluye el marco: se descuentan el grosor y el padding del
% \fcolorbox para que \mockup{\textwidth}{...} no se pase del margen.
\newcommand{\mockup}[2]{%
    \raisebox{0pt}[\height][0pt]{%
        \fcolorbox{black!30}{white}{%
            \includegraphics[width=\dimexpr#1-2\fboxsep-2\fboxrule\relax]{#2}%
        }%
    }%
}
...
\tikzset{
    ...
    c4store/.style={draw, dashed, rounded corners=2pt, fill=ForestGreen!10, minimum width=2.5cm, minimum height=1cm, align=center, font=\footnotesize},
...
\titleformat{\section}
  {\bfseries\fontsize{14pt}{14pt}\selectfont}
  {\thesection}{1em}{}
\titlespacing*{\section}{0pt}{20pt plus 6pt minus 4pt}{8pt}

\titleformat{\subsection}
  {\bfseries\fontsize{14pt}{14pt}\selectfont}
  {\thesubsection}{1em}{}
\titlespacing*{\subsection}{0pt}{17pt plus 5pt minus 3pt}{6pt}

\titleformat{\subsubsection}
  {\bfseries\fontsize{14pt}{14pt}\selectfont}
  {\thesubsubsection}{1em}{}
\titlespacing*{\subsubsection}{0pt}{14pt plus 4pt minus 2pt}{6pt}
